export async function scrapeWantedJobs(tagId: number = 872, limit: number = 20): Promise<string[]> {
...
if (require.main === module) {
  scrapeWantedJobs(872, 3).then(jds => {
    console.log(`Scraped ${jds.length} jobs.`);
    console.log(jds[0]);
  });
}
